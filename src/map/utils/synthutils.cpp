...
//#define _DSP_SYNTH_DEBUG_MESSAGES_ // enable debugging messages
...
/********************************************************************
*                                                                   *
* We are trying to increase the skill of the character.             *
* Desynthesis does not increase skill. NOT TRUE, RATE IS JUST LOWER *
* Breaking does not build. Breaking tables and chairs won't make us *
* carpenter, then skill in this case does not increase.             *
*                                                                   *
********************************************************************/
