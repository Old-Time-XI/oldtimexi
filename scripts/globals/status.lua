...
dsp.jobSpecialAbility =
{
    ...
    -- AZURE_LORE           = 2257,
    -- AZURE_LORE           = 3481,
    -- WILD_CARD_LAMIA      = 1934,
    -- WILD_CARD_HUMANOID   = 2007,
    -- WILD_CARD_           = 2258,
    -- OVERDRIVE            = 1935,
    -- OVERDRIVE            = 2008,
    -- OVERDRIVE            = 2259,
    ...
    -- TABULA_RASA          = 2261,
    -- TABULA_RASA          = 2358,
    -- TRANCE               = 2260, -- Used by Laila
    -- TRANCE               = 2710, -- Used by Lady Lillith, unlocks access to Fatal Allure
    ELEMENTAL_SFORZO_GENERIC  = 3265, -- Used by an Orc in Ambuscade
    ELEMENTAL_SFORZO_HUMANOID = 3479, -- Used by Helmwige, Ortlinde, and Schwertleite https://www.bg-wiki.com/bg/Black_And_White
    -- BOLSTER              = 3482,
}
