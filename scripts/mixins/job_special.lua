...
local job2hr = {
    ...
    [dsp.job.RUN] = dsp.jsa.ELEMENTAL_SFORZO_GENERIC,
}
...
local effectByAbility =
{
    ...
    [dsp.jsa.ELEMENTAL_SFORZO_GENERIC] = dsp.effect.ELEMENTAL_SFORZO,
    [dsp.jsa.ELEMENTAL_SFORZO_HUMANOID] = dsp.effect.ELEMENTAL_SFORZO,
}
